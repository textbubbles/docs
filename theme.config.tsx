...
const config: DocsThemeConfig = {
  ...
  head: (
    <>
      ...
      <meta name="description" content="TextBubbles API documentation — send iMessages with automatic SMS fallback via a unified REST API. Endpoints for messages, webhooks, and more." />
