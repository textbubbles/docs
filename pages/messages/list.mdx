...
Inbound messages from contacts are delivered via the `message.inbound` webhook event. To receive them, subscribe to `message.inbound` in your [webhook configuration](/webhooks/events).
