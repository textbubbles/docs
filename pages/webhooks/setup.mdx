...
> Prefer to fill in a form? See the [Interactive Configurator](/webhooks/configurator) — it generates the exact `curl` command for your inputs and can optionally send the request live.
