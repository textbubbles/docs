    ...
    "attachments": [
      {
        ...
        "filename": "photo.jpg",
        "totalBytes": 248000,
        "downloadUrl": "https://api.textbubbles.com/v1/attachments/att_550e8400/download"
      }
    ]
  }
}
...
| `attachments[].downloadUrl` | string | URL to download the attachment content (requires API key authentication) |
