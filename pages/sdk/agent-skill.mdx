...
- Customer-scoped authentication and address authorization
- Webhook event handling patterns (including wildcard subscriptions and structured reaction events)
...
- "Send a message from a specific authorized address"
- "Set up a webhook handler for message.inbound events in Next.js"
- "Subscribe to all webhook events using wildcard"
- "List all inbound messages"
- "Handle structured reaction webhooks"
...
| **Authentication** | Customer-scoped API keys and address authorization |
| **Webhooks** | Event types, wildcard subscriptions, structured reactions, and signature verification |
| **Inbound Messages** | Receiving and listing inbound messages |
