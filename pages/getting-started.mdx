...
Each API key is tied to a specific customer account, which determines your authorized sender addresses and data isolation. API keys are hashed on the server — **save your key immediately**, as it cannot be retrieved later.
